...
A quantum description of any molecular interaction may be viewed as
...
Second, in section (\ref{ss:cc}) we present the wave function-based method which the bulk 
